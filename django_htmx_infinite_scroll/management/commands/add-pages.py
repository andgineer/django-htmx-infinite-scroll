...
class Command(BaseCommand):  # type: ignore  # pylint: disable=missing-class-docstring
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        highest_page_number = (
            BookPage.objects.aggregate(max_page_number=Max("number"))["max_page_number"]
            or 0
        )
        ...
        for i in range(NUM_PAGES_TO_ADD):
            ...
            BookPage.objects.create(
                number=highest_page_number + i + 1, content=sentences
